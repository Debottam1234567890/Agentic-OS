    ...
    def render(self) -> str:
        ...
        for pt in self.points:
            ...
            if self.hovered_file and self.hovered_file == pt['path']:
                ...
                grid[y][x] = '[bold yellow]*[/bold yellow]'
...
class GalaxyScreen(Screen):
    ...
    def compose(self) -> ComposeResult:
        yield Header()
        with Horizontal():
            yield GalaxyCanvas(os.path.join(os.getcwd(), 'data_galaxy', 'coordinates.json'), id='galaxy_canvas')
